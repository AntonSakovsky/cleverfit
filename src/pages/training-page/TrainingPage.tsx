...
import { setModalVisible, setTrainingRoute } from '@redux/reducers/TrainingPageSlice';
import {
...
import { TrainingPageContent } from './Content/TrainingPageContent';
import { TrainingPageHeader } from './Header/TrainingPageHeader';
...
export const TrainingPage = () => {
    ...
    useEffect(() => {
        ...
        return () => {
            ...
            dispatch(setTrainingRoute('trainings'));
